...
public class RSAEncrypt {
	...
	private static final String DEFAULT_PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDrUUwBjj0lVWubst1p49N9Y9ti"
			+ "\r"
			...
			+ "\r" + "66qVIx3fNOwrjlz+0QIDAQAB" + "\r";

	private static final String DEFAULT_PRIVATE_KEY = "MIICdwIBADANBgkqhkiG9w0BAQEFAASCAmEwggJdAgEAAoGBAOtRTAGOPSVVa5uy"
			+ "\r"
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.arraycopy(encryptStr.getBytes(), 0, en_content, 0,
					encryptStr.getBytes().length);
